...
from src.common import TUNE_STUDY_TIMEOUT, WANDB_ENTITY, WANDB_PROJECT
from src.common.runtime.config.argument import AddOnlyNamespace
from src.common.runtime.log.TerminalIO import TerminalIO
from src.experiment.pipeline.PipelineHelper import PipelineHelper
...
class OptunaTuner(BaseTuner):
    ...
    def tune(self):
        ...
        study.enqueue_trial(params=self.model_class.define_default_params())
        # Optimize the study
        study.optimize(
            self.objective,
