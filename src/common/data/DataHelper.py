...
from camel.data.transform import CategoryTransform, NumericTransform, SimpleImputeTransform, TargetTransform
...
class DataHelper:
    ...
    def create_data_module(cls, args):
        ...
        data_module = DataModule(
            ...
            dependency_dict=dataset_dict_original["full_set"].dependency_dict,
        )
    ...
    def load_curate_data(args):
        ...
        subsample_dict = curate_set.subsample(
            subsample_mode=args.split_mode,
            subsample_size=int(args.curate_ratio * args.train_num_samples_split),
        )
        curate_set = subsample_dict["dataset_subsample"]
