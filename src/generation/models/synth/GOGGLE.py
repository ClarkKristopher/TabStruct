from synthcity.plugins.generic.plugin_goggle import GOGGLEPlugin

from src.common.runtime.error.ManualStopError import ManualStopError

from ..BaseGenerator import BaseSynthcityJointGenerator


class GOGGLE(BaseSynthcityJointGenerator):
