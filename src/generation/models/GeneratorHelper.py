...
from src.common.model.BaseModelHelper import BaseModelHelper
from src.common.runtime.log.FileHelper import FileHelper
    ...
    def _model_handler(cls, model):
        ...
        match model:
            ...
            case "great":
                ...
                model_class = GReaT
            case "tabebm":
                from .custom.TabEBM import TabEBM

                model_class = TabEBM
            case "nrgboost":
                from .custom.NRGBoost import NRGBoost

                model_class = NRGBoost
            case "tabsyn":
                from .custom.tabsyn.TabSyn import TabSyn

                model_class = TabSyn
            case "tabdiff":
                from .custom.tabdiff.TabDiff import TabDiff
