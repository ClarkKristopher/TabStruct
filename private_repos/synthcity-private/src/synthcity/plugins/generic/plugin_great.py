...
class GReaTPlugin(Plugin):
    ...
    def _fit(
        ...
        **kwargs: Any,
        ...
        Raises:
            ValueError: Conditional column must be a string for GReaT fitting.
    ...
    def _generate(self, count: int, syn_schema: Schema, **kwargs: Any) -> pd.DataFrame:
        ...
        Raises:
            ValueError: The conditional column must be a list for GReaT generation.
        ...
        return self._safe_generate(
            ...
            count,
            syn_schema,
            start_col=self.conditional_col,
            start_col_dist=conditional_col_dist,
            k=100,
            max_length=1000,
        )
