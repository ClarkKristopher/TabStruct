...
from pgmpy.estimators.CITests import chi_square, ci_pillai, pearsonr
...
class StructureEvaluator(MetricEvaluator):
    """
    .. inheritance-diagram:: synthcity.metrics.eval_structure.StructureEvaluator
        :parts: 1
...
class CITest(StructureEvaluator):
    """
    .. inheritance-diagram:: synthcity.metrics.eval_structure.CITest
        :parts: 1
        ...
        for dependency in dependency_list:
            ...
            match test_method:
                case "pillai":
                    ...
                    _, p_value = ci_pillai(X, Y, S, X_syn_df, boolean=False)
                case "chi_square":
...
class UtilityPerFeature(StructureEvaluator):
    """
    .. inheritance-diagram:: synthcity.metrics.eval_structure.UtilityPerFeature
        :parts: 1
